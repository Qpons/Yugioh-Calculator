...
player1Name.grid(row=0,column=0,columnspan=2)
player1Name.insert(0, 'Player 1')

Label(topFrame, textvariable=player1HPVar).grid(row=1,column=0,columnspan=2)
...
player2Name.grid(row=0,column=3,columnspan=2)
player2Name.insert(0, 'Player 2')

Label(topFrame, textvariable=player2HPVar).grid(row=1,column=3,columnspan=2)
